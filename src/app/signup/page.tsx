...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setIsError(false);
      setMessage('Berhasil! Silakan periksa email Anda untuk memverifikasi akun Anda.');
      ...
      <div className="w-full max-w-md">
        <div className="mb-10 text-left">
          ...
          <p className="text-gray-600 mt-3">
            Bergabunglah dengan kami! Silakan masukkan detail Anda untuk memulai.
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          {message && (
            <div
              className={`p-3 rounded-lg text-center text-sm ${isError
